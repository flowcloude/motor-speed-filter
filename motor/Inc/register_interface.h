...
/* User Filter Registers - 4种滤波输出 */
#define  MC_REG_FILT_RAW      ((200U << ELT_IDENTIFIER_POS) | TYPE_DATA_16BIT)
#define  MC_REG_FILT_MAVG     ((201U << ELT_IDENTIFIER_POS) | TYPE_DATA_16BIT)
#define  MC_REG_FILT_LPF      ((202U << ELT_IDENTIFIER_POS) | TYPE_DATA_16BIT)
#define  MC_REG_FILT_KALM     ((203U << ELT_IDENTIFIER_POS) | TYPE_DATA_16BIT)
#define  MC_REG_FILT_MED      ((204U << ELT_IDENTIFIER_POS) | TYPE_DATA_16BIT)
